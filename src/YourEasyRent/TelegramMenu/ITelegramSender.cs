namespace YourEasyRent.TelegramMenu
{
    public interface ITelegramSender
    {
        ...
        Task SendResults(string chatId, string resultsMesage);  //string results. это аналог на Task<IEnumerable<string>> SendAllResult, но поскольку это не клавиатура, а просто результат стрики 
